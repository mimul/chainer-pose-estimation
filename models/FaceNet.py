...
class FaceNet(chainer.Chain):
    ...
    def __init__(self):
        super(FaceNet, self).__init__(
            ...
            conv6_2_CPM=L.Convolution2D(in_channels=512, out_channels=71, ksize=1, stride=1, pad=0),

            # stage2
            Mconv1_stage2=L.Convolution2D(in_channels=199, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage2=L.Convolution2D(in_channels=128, out_channels=71, ksize=1, stride=1, pad=0),

            # stage3
            Mconv1_stage3=L.Convolution2D(in_channels=199, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage3=L.Convolution2D(in_channels=128, out_channels=71, ksize=1, stride=1, pad=0),

            # stage4
            Mconv1_stage4=L.Convolution2D(in_channels=199, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage4=L.Convolution2D(in_channels=128, out_channels=71, ksize=1, stride=1, pad=0),

            # stage5
            Mconv1_stage5=L.Convolution2D(in_channels=199, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage5=L.Convolution2D(in_channels=128, out_channels=71, ksize=1, stride=1, pad=0),

            # stage6
            Mconv1_stage6=L.Convolution2D(in_channels=199, out_channels=128, ksize=7, stride=1, pad=3),
            ...
            Mconv7_stage6=L.Convolution2D(in_channels=128, out_channels=71, ksize=1, stride=1, pad=0),
        )
